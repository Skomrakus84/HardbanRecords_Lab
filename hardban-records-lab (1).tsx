      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium">+12%</span>
          </div>
          <div className="mt-4">
            <div className="text-3xl font-bold text-gray-900">{statsData.activeArtists}</div>
            <div className="text-gray-600">Active Artists</div>
            <div className="text-sm text-gray-500 mt-1">New signings this month</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium">+8%</span>
          </div>
          <div className="mt-4">
            <div className="text-3xl font-bold text-gray-900">{statsData.totalReleases}</div>
            <div className="text-gray-600">Total Releases</div>
            <div className="text-sm text-gray-500 mt-1">Albums & Singles released</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium">+15%</span>
          </div>
          <div className="mt-4">
            <div className="text-3xl font-bold text-gray-900">{statsData.publishedBooks}</div>
            <div className="text-gray-600">Published Books</div>
            <div className="text-sm text-gray-500 mt-1">Books in our catalog</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          ...
          <div className="mt-4">
            ...
            <div className="text-sm text-gray-500 mt-1">Combined music + publishing revenue</div>
          </div>
        </div>
      </section>
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-blue-100">+18% vs last month</div>
            </div>
          </div>
          <div className="mt-4">
            <div className="text-lg font-semibold">Total Streams</div>
            <div className="text-blue-100">Across all platforms</div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-green-100">+31% vs last month</div>
            </div>
          </div>
          <div className="mt-4">
            <div className="text-lg font-semibold">Book Sales</div>
            <div className="text-green-100">Digital + Print copies</div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-purple-100">Total active platforms</div>
            </div>
          </div>
          <div className="mt-4">
            <div className="text-lg font-semibold">Platform Coverage</div>
            <div className="text-purple-100">400 music + 21 publishing</div>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-blue-600 text-sm font-medium">5 Active</span>
          </div>
